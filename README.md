...
This is a fork of slack-go/slack by Norberto Lopes, with some patches to ease my usage.
...
```bash
go mod edit -replace github.com/slack-go/slack=github.com/nanmu42/slack@latest
```
